...
## %bb.0:
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__Z10printErrorii       ## -- Begin function _Z10printErrorii
	.p2align	4, 0x90
__Z10printErrorii:                      ## @_Z10printErrorii
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
## %bb.0:
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__Z12printSuccessv      ## -- Begin function _Z12printSuccessv
	.p2align	4, 0x90
__Z12printSuccessv:                     ## @_Z12printSuccessv
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
## %bb.1:
	...
	jne	LBB6_3
## %bb.2:
	callq	__Z12printSuccessv
	jmp	LBB6_4
LBB6_3:
	movl	-16(%rbp), %edi
	movl	-20(%rbp), %esi
	callq	__Z10printErrorii
LBB6_4:
	movl	-4(%rbp), %eax
	addq	$32, %rsp
	popq	%rbp
